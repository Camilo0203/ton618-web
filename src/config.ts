...
export const config = {
  ...
  whopDonation2: import.meta.env.VITE_WHOP_DONATION_2 || '',
  whopDonation5: import.meta.env.VITE_WHOP_DONATION_5 || '',
  whopDonation10: import.meta.env.VITE_WHOP_DONATION_10 || '',
  whopDonation25: import.meta.env.VITE_WHOP_DONATION_25 || '',
