  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0 pointer-events-none select-none">
        ...
        <div className="absolute inset-x-[24%] top-[36%] h-[20rem] rounded-full bg-[radial-gradient(circle,rgba(255,255,255,0.06)_0%,rgba(99,102,241,0.08)_24%,transparent_68%)] blur-[120px]" />
