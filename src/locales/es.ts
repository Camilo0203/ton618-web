export const es = {
    translation: {
        ...
        testimonials: { tag: 'Ejemplos de Comunidades', title: 'Lo Que Dicen', titleAccent: 'Los Equipos', description: 'Ejemplos de cómo servidores de Discord usan TON618 para sus operaciones diarias.', items: { t1: { name: 'Horizon Gaming', role: 'Equipo Admin', server: 'Servidor Gaming', members: '12K miembros', quote: 'Desde que migramos a TON618 es mucho más fácil para el staff seguir tickets, warns y verificación en un mismo flujo.' }, t2: { name: 'Código Latam', role: 'Equipo Mod', server: 'Servidor Comunidad', members: '8K miembros', quote: 'Los flujos de automatización nos salvaron. Onboarding, verificación y soporte funcionan solos ahora.' }, t3: { name: 'Creative Hub', role: 'Equipo Staff', server: 'Servidor Creativo', members: '25K miembros', quote: 'La analítica en vivo y los logs de moderación nos dan visibilidad total. No volvería a otro bot.' } } },
        ...
        dashboard: {
            ...
            overview: {
                ...
                pulse: { bridgeTitle: 'Sincronizacion y bridge', connected: 'Sistema conectado al servidor', pending: 'Instalacion pendiente', bridgeDesc: 'El bridge traducira aqui su estado tecnico a senales faciles de seguir.', details: { changes: { label: 'Cambios pendientes', empty: 'No hay cola pendiente.' }, support: { label: 'Tickets abiertos', empty: 'Sin carga de soporte actual.' }, backup: { label: 'Ultimo backup', none: 'No existe aun', ready: 'Ya puedes volver atras si hace falta.', create: 'Crea uno antes de cambios delicados.' }, base: { label: 'Checklist base', none: 'No quedan tareas base pendientes.' } } },
                syncFacts: { bridge: 'Bridge', heartbeat: 'Heartbeat', inventory: 'Inventario', config: 'Config aplicada' },
